const Theme = () => {
    return (
        <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M10.9302 10.93L12.3402 12.34" stroke="#4B5563" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M23.6602 23.66L25.0702 25.07" stroke="#4B5563" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            ...
            <path d="M12.3402 23.66L10.9302 25.07" stroke="#4B5563" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M25.0702 10.93L23.6602 12.34" stroke="#4B5563" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
